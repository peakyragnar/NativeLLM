...
def optimize_financial_tables(content: str) -> str:
    ...
    # Replace patterns of consecutive |-|-| with a single |-|
    # This is done using a regex that matches consecutive |-| patterns
...
def main():
    ...
    if len(sys.argv) != 3:
        logger.error("Usage: python test_regex_optimizer.py <input_file> <output_file>")
        return 1
