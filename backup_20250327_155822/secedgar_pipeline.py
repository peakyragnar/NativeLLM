...
from src.edgar.edgar_utils import get_company_name_from_cik, get_cik_from_ticker
...
def get_cik_from_ticker_secedgar(ticker: str) -> Optional[str]:
    """Get CIK from ticker using our existing edgar_utils implementation"""
    try:
        # Use our existing CIK lookup function
