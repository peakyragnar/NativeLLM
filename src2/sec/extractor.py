...
class SECExtractor:
    ...
    def extract_inline_xbrl(self, html_path):
        ...
        try:
            ...
            # Use lxml parser for XML documents
            # Note: Either use 'lxml' or 'xml' but not both to avoid duplicate features parameter
            ...
            if not ix_tags:
                ...
                try:
                    ...
                    if ix_tags:
                         ...
                         # This is not a critical error, we can continue with other extraction methods
                         logging.info("Continuing with other extraction methods.")
